...
from app.modules.software_management.category.api.category_schema import (
    CategoryCreate,
    CategoryPage,
    CategoryResponse,
    CategoryUpdate,
)
from app.modules.software_management.category.application.category_service import (
    CategoryService,
)
...
def get_unit_of_work(session: UnitOfWork = Depends(get_db)) -> UnitOfWork:
