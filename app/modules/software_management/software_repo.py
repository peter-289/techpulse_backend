...
from app.modules.software_management.software import Artifact, ArtifactStatus, SemVer, Software, SoftwareStatus, SoftwareVisibility, Version, VersionStatus
...
class SoftwareRepository:
    ...
    async def list_visible_for_user(self, user_id: UUID, *, limit: int = 100) -> list[Software]:
        stmt = (
            select(SoftwareModel)
        ...
        return [_software_to_entity(row) for row in rows]
