...
class AuditService:
        ...
        *,
        ...
        try:
            async with self.uow:
                ...
                await self.uow.audit_repo.add_event(event)

                # Ensure DB-generated fields like `id`
                # are available before detection.

                await self._detect_and_create_alerts(event)
    ...
    async def _detect_and_create_alerts(
        self,
        event: AuditEvent,
    ) -> None:
        """
        ...
        if (
            ...
            failures = await self._count_events(
        ...
        #
            ...
            denied_count = await self._count_events(
    ...
    async def _count_events(
        ...
        *,
        ...
        return await self.uow.audit_repo.count_events(predicates)
    ...
    async def _create_alert(
        ...
        *,
        ...
        existing_alert = (
            await self.uow.audit_repo.get_alert(
                predicates
            )
        )
        ...
        await self.uow.audit_repo.add_alert(alert)
