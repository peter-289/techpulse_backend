...
from app.infrastructure.database.models import audit_event, chat_message, payment, project, resource, security_alert, session, software

logger = logging.getLogger(__name__)

# No migrations during app lifecycle
"""
